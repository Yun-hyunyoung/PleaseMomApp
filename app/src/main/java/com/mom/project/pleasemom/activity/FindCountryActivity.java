...
import com.mom.project.pleasemom.adapter.AutoCountryNameAdapter;
 ...
 */
public class FindCountryActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn = (Button)findViewById(R.id.btnFindCountry);
        autoTextView  = (AutoCompleteTextView)findViewById(R.id.autoFindCountry);
        autoTextView.setThreshold(1);
        AutoCountryNameAdapter adapter = new AutoCountryNameAdapter(this, R.layout.autocomplete_country_name, airportDTOs);
        autoTextView.setAdapter(adapter);

        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MainActivity.BoardListFragment.txtArrival.setText(autoTextView.getText());
                finish();
            }
        });
    }
