 ...
 */
public class WriteAirportActivityArrival extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_write_airport_arrival);
        loadAirportInfo();

        Button btn = (Button)findViewById(R.id.btnFindAirport);
        autoTextView  = (AutoCompleteTextView)findViewById(R.id.autoFindAirportArrival);
        autoTextView.setThreshold(1);

        returnTextView = BoardWriteActivity.txtArrival;
